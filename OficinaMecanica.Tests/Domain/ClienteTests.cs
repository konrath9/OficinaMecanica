...
namespace OficinaMecanica.Tests.Domain
{
    public class ClienteTests
    {
        ...
        {
            var cliente = new Cliente("João Silva", "529.982.247-25", "joao@email.com", "11999999999");
        ...
        {
            Assert.Throws<ArgumentException>(() =>
                new Cliente("João", "111.111.111-11"));
        }
        ...
        public void Atualizar_ComDadosValidos_DeveAtualizarCampos()
        {
            ...
            cliente.Atualizar("João Atualizado", "novo@email.com", "11988888888");
