...
namespace OficinaMecanica.Infrastructure.Migrations
{
    ...
    [Migration("20260828131451_AddClienteAtivo")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OficinaMecanica.Domain.Entities.OrdemServico", b =>
                {
                    b.OwnsMany("OficinaMecanica.Domain.ValueObjects.HistoricoStatusOrdemServico", "HistoricoStatus", b1 =>
                        {
                            b1.Property<int>("id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("integer")
                            ...
                            b1.Property<DateTime>("OcorridoEm")
                                .HasColumnType("timestamp with time zone")
                            ...
                            b1.ToTable("ordem_servico_historico_status", (string)null);
