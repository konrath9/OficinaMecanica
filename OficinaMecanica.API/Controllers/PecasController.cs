...
namespace OficinaMecanica.API.Controllers
{
    ...
    public class PecasController : ControllerBase
    {
        ...
        /// <summary>Lista todas as pe�as do estoque.</summary>
        [HttpGet]
        public async Task<IActionResult> Listar(CancellationToken cancellationToken)
        {
            ...
            catch (Exception ex)
            {
                ...
                return StatusCode(500, new { message = "Erro ao listar pe�as" });
            }
        }

        /// <summary>Lista pe�as com estoque zerado.</summary>
        [HttpGet("sem-estoque")]
        public async Task<IActionResult> ListarSemEstoque(CancellationToken cancellationToken)
        {
            ...
            catch (Exception ex)
            {
                ...
                return StatusCode(500, new { message = "Erro ao listar pe�as sem estoque" });
            }
        }

        /// <summary>Obt�m uma pe�a pelo Id.</summary>
        [HttpGet("{id}")]
        public async Task<IActionResult> ObterPorId(Guid id, CancellationToken cancellationToken)
        {
            ...
            catch (Exception ex)
            {
                ...
                return StatusCode(500, new { message = "Erro ao obter pe�a" });
            }
        }

        /// <summary>Cria uma nova pe�a no estoque.</summary>
        [HttpPost]
            ...
            CancellationToken cancellationToken)
        {
            ...
            catch (Exception ex)
            {
                ...
                return StatusCode(500, new { message = "Erro ao criar pe�a" });
            }
        }

        /// <summary>Atualiza os dados de uma pe�a.</summary>
        [HttpPut("{id}")]
            ...
            CancellationToken cancellationToken)
        {
            ...
            catch (Exception ex)
            {
                ...
                return StatusCode(500, new { message = "Erro ao atualizar pe�a" });
            }
        }

        /// <summary>Exclui uma pe�a do estoque.</summary>
        [HttpDelete("{id}")]
        public async Task<IActionResult> Excluir(Guid id, CancellationToken cancellationToken)
        {
            ...
            catch (Exception ex)
            {
                ...
                return StatusCode(500, new { message = "Erro ao excluir pe�a" });
            }
        }

        /// <summary>
        /// Movimenta o estoque de uma pe�a.
